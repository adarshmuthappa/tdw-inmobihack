...
//		//my stuff
//		[SerializeField] private Text pointA;
//		[SerializeField] private Text pointB;
...
//		{
//			dist = 0.00f;
//			distText.text = "Distance: " + dist.ToString ("F2") + " m";//initializing UI elements
//			pointA.text = "Point A: " + startPoint;
//			pointB.text = "Point B: " + endPoint;
//		}
		...
		//my stuff
//		private void CalculateDistance(Vector2 position)
//		{
//			RaycastHit hit;
//			Ray ray = Camera.main.ScreenPointToRay (position);//generates the ray of light from the main camera tracking mouse positon
//			//Debug.DrawRay (ray.origin, ray.direction * 10, Color.cyan);//draw the ray of light for demo purpose
//
////			if(Input.GetMouseButtonDown(0)){//checking if mouse is clicked
//				if(Physics.Raycast(ray, out hit)) {//raycast function in which you pass the ray and the hit object
//					if(startPoint==Vector3.zero) {
//						startPoint = hit.point;//obtain the hit point of ray with collider
//						pointA.text = "Point A: " + startPoint;//set the text value in the UI element
//						pointB.text = "Point B: " + endPoint;
//						Debug.Log("First Hit point: " + startPoint);
//					}
//					else {
//						endPoint = hit.point;
//						pointB.text = "Point B: " + endPoint;
//						Debug.Log("First Hit point: " + startPoint + " + Second Hit point: " + endPoint);
//						dist = Vector3.Distance(startPoint, endPoint);
//						Debug.Log("Distance: " + dist.ToString());
//						distText.text = "Distance: " + dist.ToString("F6") + " m";//round to 6 decimal places. F2 will be for 2 decimal places and so on
...
//		}
        ...
        private void CheckInput()
        {
            ...
            if (Input.GetButtonDown("Fire1"))
            {
				...
				//my stuff
				//CalculateDistance(m_MouseDownPosition);
